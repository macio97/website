...
require_once('backend/products_list.php');
...
//Setting page title
$DOM = str_replace('<title_page_to_insert/>', 'Products', $DOM);
////////////
...
if(Admin::verify()){	//IF LOGGED
	...
	$DOM = str_replace('<edit_li_to_insert/>', '<li class="main"><a href="<relative_path_to_insert/>admin/editpage.php?pagename=products.php">Edit</a></li>', $DOM);
	$DOM = str_replace('<logout_li_to_insert/>', '<li class="main"><a href="<relative_path_to_insert/>products.php?logout=true">Logout</a></li>', $DOM);
}else{					//IF NOT
...
//Getting page content
$DOM = str_replace('<page_to_insert/>', file_get_contents('html/products.html'), $DOM);
////////////

//Fixing products informations
$DOM = str_replace('<products_list_to_insert/>', products_list::getlist(Admin::verify()), $DOM);
////////////
